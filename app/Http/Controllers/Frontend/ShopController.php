...
class ShopController extends Controller
{
    ...
    public function addCart(Request $request)
    {
        ...
        if (count($cart) > 0) {
            ...
            foreach ($cart as $item) {
                ...
                if ($item->options->product_detail->id == $request->product_detail_id) {
                    ...
                    return $this->dataError('Sản phẩm hiện đang có trong giỏ hàng của bạn. Bạn có muốn di chuyển tới giỏ hàng không?');
                } else {
        ...
        // dd(Cart::content());
        return $this->dataSuccess('Thêm vào giỏ hàng thành công');
    }
    ...
    public function deleteCart(Request $request)
    {
        ...
        return $this->dataSuccess('Xoá sản phẩm thành công');
    }
    ...
    public function updateCart(Request $request)
    {
        ...
        return $this->dataSuccess('Cập nhật sản phẩm thành công');
    }
    ...
    public function postBill(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return $this->dataError('Xin kiễm tra lại thông tin của bạn', $array);
        } else {
            ...
            if ($saveBill) {
                ...
                if ($temp == false) {
                    ...
                    return $this->dataError('Lưu chi tiết đơn hàng thất bại', $array);
                } else {
                    ...
                    return $this->dataSuccess('Đơn hàng của bạn đang được xử lý!', $saveBill);
                }
            } else {
    ...
    // {
    //     $sp= $this->product->nhanTest();    
    //     dd($sp);
    // }

    // public function editSP(Request $req,$id)
    // {
    //     $new = $this->product->update([
    //         'name' =>$req['name'],
    //         'status'=>$req['status'],
