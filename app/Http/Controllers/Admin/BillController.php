...
class BillController extends Controller
{
    ...
    {   
        ...
        {   
            ...
            return $this->dataError('Chỉ có thể thay đổi những đơn hàng có trạng thái Đang xử lý hoặc Đã thanh toán!', 1);
        }
        
        if($updateBill)
        {
            return $this->dataSuccess('Thay đổi trạng thái đơn hàng thành công!');
        }else{

            return $this->dataError('Thất bại!', $errors);
        }
    }
    ...
    public function destroyMulti(Request $request)
    {
        ...
        if($deleteMulti){
            ...
            return $this->dataSuccess('Xóa đơn hàng thành công!');
    ...
    {   
        ...
        if(!empty($check))
        {
            return $this->dataSuccess('Xuất đơn hàng thành công!', ['url'=>'/upload/pdf/'.$fileName]);
        }
        return $this->dataError('Thất bại!');
    }
}
