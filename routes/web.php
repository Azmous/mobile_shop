...
Route::group(['middleware'=>'admin', 'prefix'=>'admin'], function (){
	...
	//Route::group(['middleware'=>'password2nd'],function (){
		...
		Route::post('/product/store', 'Admin\ProductController@store')->name('admin.product.store');//Store(Add)
		Route::post('/product/update', 'Admin\ProductController@update')->name('admin.product.update');//Update
		Route::post('/product/delete', 'Admin\ProductController@destroyMulti')->name('admin.product.delete');//Detroy
...
Route::group(['middleware'=>'cart'],function (){//ReStore Cart to DB
	...
	// Route::get('/ajax/get-list-id-paypal', 'Admin\PayPalController@getListIdPaypal')->name('frontend.ajax.get_paypal_id');

});
////
Route::get('/listsp', 'Frontend\ShopController@nhanTest')->name('listsp');

Route::get('/editsp/{id}', 'Frontend\ShopController@editSP')->name('editsp');
