                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                ...
                                <small>Hiển thị <b> {{count($listBrand)}}</b> trên <b>{{count($listBrand)}}</b> thương hiệu</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <table class="table table-hover middle-table-text">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center">Hình đại diện</th>
...
@section('footer')
    <script>
        $('.btnDelete').click(function (e) {
            ...
            e.preventDefault();
            if (confirm('Bạn có chắc chắn muốn xóa những thương hiệu này?')){
        ...
        $('.btnEdit').click(function(){
            ...
            $('#headerEdit').empty();
            $('#headerEdit').append('Sửa thương hiệu '+ value.name);
