                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                ...
                                <small>Hiển thị  <b>{{count($listUser)}}</b> trên <b>{{$listUser->total()}}</b> người dùng</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <table class="table table-hover middle-table-text">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center">Nền tảng</th>
                                                ...
                                                <th rowspan="2" class="text-center thsoluong">Địa chỉ</th>
                                                <th rowspan="2" class="text-center thloaisp">Số điện thoại</th>
                                                <th rowspan="2" class="text-center ththuonghieu">Giới tính</th>
