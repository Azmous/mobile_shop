...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                THÔNG TIN CẢ NHÂN &nbsp
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-home"></i>Trang chủ</a></li>
                <li class="active">Thông tin cả nhân</li>
            </ol>
        </section>
                                ...
                                <form id="editForm" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" name="first_name" placeholder="first name" title="Nhập họ ..." value="{{$user->first_name}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            ...
                                            <input type="text" class="form-control" name="last_name" placeholder="last name" title="Nhập tên ..." value="{{$user->last_name}}">
                                        </div>
                                    </div>
                                    <div class="form-group">

                                        <div class="col-xs-6">
                                            <label for="email"><h4>Số điện thoại</h4></label>
                                            <input type="text" class="form-control" placeholder="Type your phone" title="Nhập số điện thoại ..." value="{{$user->phone}}" name="phone">
                                        </div>
                                    </div>
                                    <div class="form-group">

                                        <div class="col-xs-6">
                                            <label for="password"><h4>Địa chỉ</h4></label>
                                            <input type="text" class="form-control" name="address" placeholder="Type your address" title="Nhập địa chỉ ..." value="{{$user->address}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            <label for="gender"><h4>Giới tính</h4></label><br>
                                   ...
                                   <!--  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-xs-12 text-center mt-10">
                                            ...
                                            <a class="btn btn-danger" data-toggle="modal" data-target="#myModal">Đổi mật khẩu Password</a>
                                        </div>
                                    </div>
                                </form>
