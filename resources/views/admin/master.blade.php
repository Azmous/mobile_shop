...
<head>
    ...
    <title>MobileTT Management</title>
...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo -->
        <a href="{{route('admin.product.list')}}" class="logo">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini">TT</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>MobileTT</b></span>
        </a>
        ...
        <nav class="navbar navbar-static-top">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    <li>
                        <a style="font-weight: bolder;">Xin chào , <i> {{Auth::guard('admin')->user()->username}}</i></a>
                    </li>
                    <li>
                        <a href="{{route('admin.logout')}}" style="font-weight: bolder;">ĐĂNG XUẤT</a>
                    </li>
                </ul>
            </div>
        </nav>
   ...
   @include('admin.menu')
    ...
    <footer class="main-footer">
        <strong>MobileTT Copyright &copy; 2018.</strong> All rights reserved. By <a href="#">Admin</a>
    </footer>
...
<script src="{{asset('/template/admin/')}}/plugins/colorpicker/js/layout.js" type="text/javascript"></script>
