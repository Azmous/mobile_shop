			...
			<div class="modal-body" style="text-align: center;">
				<div class="box box-solid box-primary">
					<div class="box-header" style="cursor: pointer; text-align: center;" data-toggle="tooltip">
						<h3 class="box-title" id="headerBill" style="float: left;">THÔNG TIN CHI TIẾT ĐƠN HÀNG</h3>
						<a style="float: right;" id="downloadBill"><i class="fa fa-download"></i> Tải xuống</a>
					</div>
						...
						<div class="row mt-10">
							<div class="col-lg-12">
								<div class="col-lg-6">
									<div class="form-group">
										<div class="row">
											<label class="col-sm-3 control-label">Ngày vận chuyển</label>
											<div class="col-sm-9">
							...
							<div class="col-lg-12">
								<div class="form-group">
									<div class="row">
										...
										<a class="btn btn-success statusBtn" data-status="2">Hoàn thành</a>
										<a class="btn btn-danger statusBtn" data-status="3">Hủy bỏ</a>
						...
						<div class="row">
							<div class="col-lg-12">
								<table class="table table-hover middle-table-text" style="margin-top: 15px;">
									<thead>
										<tr>
											<th class="text-center" style="border: 1px solid #cccccc;">STT</th>
											<th class="text-center" style="border: 1px solid #cccccc;">Sản phẩm (Chi tiết)</th>
											<th class="text-center" style="border: 1px solid #cccccc;">Giá</th>
											<th class="text-center" style="border: 1px solid #cccccc;">Số lượng</th>
											<th class="text-center" style="border: 1px solid #cccccc;">Tổng giá</th>
										</tr>
									</thead>
									...
									<tfoot>
										<tr>
											<td colspan="5"><b>Tổng đơn hàng: </b><a style="color: black;" id="totalInput"></a></td>
										</tr>
									</tfoot>
								</table>	
							</div>
