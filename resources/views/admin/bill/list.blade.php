                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                ...
                                <small>Hiển thị <b> {{count($listBill)}}</b> trên <b>{{count($listBill)}}</b> đơn hàng</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <table class="table table-hover middle-table-text">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center">Mã</th>
                                                <th rowspan="2" class="text-center">Ngày tạo</th>
                                                <th rowspan="2" class="text-center">Tên người dùng</th>
...
@section('footer')
    <script>
        ...
        $('.dodeletemulti').click(function(){
            ...
            if (confirm('Bạn có chắc chắn muốn xóa những đơn hàng này?')){
                var arrid = [];
                ...
                if(arrid.length > 0){
                    ...
                    alert("Vui lòng chọn những đơn hàng bạn muốn xóa!"); 
                }
            }
        });
                ...
                success: function (res) {
                    ...
                    if (res.code == 201) {
                        ...
                        if(res.data != 1){
                            ...
                            $('#error-message').append('<br>Vui lòng liên hệ với khách hàng về sự cố này...')
                        }
        ...
        $('.statusBtn').click(function(){
            if (confirm('Bạn có chắc thay đổi trang thái của đơn hàng này?')){
