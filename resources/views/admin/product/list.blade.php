                    ...
                    <div class="box">
                        <div class="box box-solid box-primary">
                            <div class="box-header">
                                ...
                                <small>Hiển thị <b>{{count($listProduct)}}</b> trên <b>{{$listProduct->total()}}</b> sản phẩm</small>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                    ...
                                    <table class="table table-hover middle-table-text">
                                        <thead>
                                            <tr>
                                                ...
                                                <th rowspan="2" class="text-center thtrangthai">Tình trạng</th>
                                                ...
                                                <th rowspan="2" class="text-center thhinhanhsanpham">Hình đại diện</th>
                                                <th rowspan="2" class="text-center thsoluong">Số lượng</th>
                                                <th rowspan="2" class="text-center ththongso">Thông số kĩ thuật</th>
                                                <th rowspan="2" class="text-center thloaisp">Danh mục</th>
                                                <th rowspan="2" class="text-center ththuonghieu">Thương hiệu</th>
                                                 <th rowspan="2" class="text-center thchucnang">Hành động</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div class="text-center">
                                    @if(count($listProduct) == 0) 
                                        <h4 style="font-weight: bold;">Không có dữ liệu</h4>
                                    @endif
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-2 text-left record-show">
                                        <select id="mySelect" class="form-control select" >
                                            <option value="20" {{ isset($_GET['per_page'])&& $_GET['per_page'] == 20 ? 'selected' : '' }}>20 dữ liệu</option>
                                            <option value="30" {{ isset($_GET['per_page'])&& $_GET['per_page'] == 30 ? 'selected' : '' }}>30 dữ liệu</option>
                                            <option value="40" {{ isset($_GET['per_page'])&& $_GET['per_page'] == 40 ? 'selected' : '' }}>40 dữ liệu</option>
                                        </select>
                                    </div> 
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        $('form#editForm').submit(function (e) {
            ...
            e.preventDefault();
            var formData = new FormData($('form#editForm')[0]);///nạp dử liệu từ view
            $.ajax({
        ...
        $('.specopen').click(function() {
            ...
            if(valuespec !== null){
                ...
                $('#specram').append(valuespec.ram + ' GB');
                $('#specdisplay').append(valuespec.monitor + ' inch');
                switch(valuespec.os){
                    case 1:
                        $('#specos').append('Android');
                        break;
                    case 2:
                        $('#specos').append('iOs');
                        break;
                ...
                $('#speccpu').append(valuespec.cpu);
                $('#specrom').append(valuespec.rom + ' GB');
                $('#specfrontcam').append(valuespec.front_camera + ' megaPixel');
                $('#specrearcam').append(valuespec.rear_camera + ' megaPixel');
                $('#specbat').append(valuespec.pin + '  mha');
                ...
                $('#speccpu').append("N/A");
                $('#specrom').append("N/A");
                $('#specfrontcam').append("N/A");
                $('#specrearcam').append("N/A");
                $('#specbat').append("N/A");
            }
        });
