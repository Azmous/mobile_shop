...
input[type='checkbox']:checked {
	...
	<div class="cart_section">
		<div class="container">
			<br>  <h3 class="text-center">GIỎ HÀNG</h3>
			<br> 
			<div class="card">
				@if(count($cart) ==0)
				...
				<table class="table table-hover shopping-cart-wrap">
					<thead class="text-muted">
						<tr style="color: #00000082;">
							...
							<th scope="col" width="120" class="text-center">Giá</th>
...
@include('frontend.element.cart.modal_checkout')
	...
	<script type="text/javascript">
		...
		$('.checkoutBtn').click(function(event) {
			if(confirm('Xin hãy kiểm tra giỏ hàng của bạn trước khi thanh toán?')){
		...
		$('.dodeletemulti').click(function(){
			...
			if (confirm('Bạn có chắc muốn xoá sản phẩm ?')){
				...
				if(arrid.length > 0){
                    	...
                    	alert("Chọn sản phẩm bạn muốn xoá"); 
                    }
                }
            });
