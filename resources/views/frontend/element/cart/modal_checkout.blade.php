	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-body">
				<div class="container">
					<div class="card">
						<h5 class="card-header text-center" style="background: #007bff;color: white;">Thông tin đơn hàng</h5>
						<div class="card-body">
							<form id="billForm" method="POST">
								...
								<div class="form-group">
									<small style="font-style: italic; color: #0000008c;">ĐƠn hàng sẽ được giao trong vòng 4-5 ngày</small>
								</div>
