...
<div class="container" style="margin-top: 55px; margin-bottom: 15px">
  <ul class="nav nav-tabs" role="tablist" style="font-size: 20;">
    <li class="nav-item">
      <a class="nav-link tab_profile" href="#profile" role="tab" data-toggle="tab" id="">Thông tin</a>
    </li>
    <li class="nav-item">
      <a class="nav-link tab_bill" href="#buzz" role="tab" data-toggle="tab" id="">Đơn hàng</a>
    </li>
    <li class="nav-item">
      <a class="nav-link tab_activities" href="#references" role="tab" data-toggle="tab" id="">Hoạt động</a>
    </li>
  </ul>
      ...
      <form id="myForm" method="POST" action="{{route('frontend.post_user_profile')}}">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 mt-10">
            ...
            <div class="row mt-3">
              <div class="col-lg-12">
                <label for="first_name" style="font-weight: bolder;">Họ</label>
                <input  class="form-control" type="text" name="first_name" value="{{$user->first_name}}"> 
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-lg-12">
                <label for="last_name" style="font-weight: bolder;">Tên</label>
                <input  class="form-control" type="text" name="last_name" value="{{$user->last_name}}"> 
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-lg-12">
                <label for="address" style="font-weight: bolder;">Địa chỉ</label>
                <input  class="form-control" type="text" name="address" value="{{$user->address}}"> 
              </div>
            </div>
            <div class="row mt-3">
              <div class="col-lg-12">
                <label for="phone" style="font-weight: bolder;">Số điện thoại</label>
                <input  class="form-control" type="text" name="phone" value="{{$user->phone}}"> 
              </div>
            </div>  
            <div class="row mt-3">
              <div class="col-lg-12">
                <label for="gender" style="font-weight: bolder;">Giời tính</label>
                <div class="row">
                  <div class="col-lg-12">
                    <div class="col-lg-3">
                      <input class="" type="radio" name="gender" value="1" @if($user->gender == 1) {{'checked'}} @endif> Nam
                    </div>
                    <div class="col-lg-9">
                      <input class="" type="radio" name="gender" value="2" @if($user->gender == 2) {{'checked'}} @endif> Nữ
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="row text-center mt-5">
          <div class="col-lg-12">
            ...
            <button class="btn btn-danger" type="reset" data-toggle="modal" data-target="#myModal">Đổi mật khẩu</button>
            @endif
          </div>
        </div>
      </form>
