<div class="register-box">
  ...
  <div class="register-box-body">
    <p class="login-box-msg"><a href="{{route('password.request')}}">Quên mật khẩu ?</a></p>
    <form id="myForm" enctype="multipart/form-data" method="POST" action="{{route('frontend.post_login')}}">
      {{ csrf_field() }}
      <!-- email -->
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Email hoặc username" name="email" id="email">
      ...
      <div class="row text-center" style="margin-left: 0px;">
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary" id="submit" style="width: 322px;">Đăng nhập</button>
        </div>
      </div>
