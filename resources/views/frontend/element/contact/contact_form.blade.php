		...
		<div class="row">
			<div class="col-lg-10 offset-lg-1">
				<div class="contact_form_container">
					<div class="contact_form_title">Phản hồi về dịch vụ của chúng tôi</div>
					...
					<form action="{{route('frontend.post_feedback')}}" id="contact_form" method="POST">
						...
						<div class="contact_form_text">
							<textarea id="contact_form_message" class="text_field contact_form_message" name="content" rows="4" placeholder="Bạn nghĩ gì về dịch vụ của chúng tôi?" required="required" style="color: #777777;"></textarea>
						</div>
