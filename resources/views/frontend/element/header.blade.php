			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{asset('/template/frontend/')}}/images/mail.png" alt=""></div><a href="{{asset('/template/frontend/')}}/mailto:fastsales@gmail.com">mobilett@gmail.com</a></div>
						<div class="top_bar_content ml-auto">
							<div class="top_bar_user">
								@if(Auth::check())
								<div class="user_icon"><img src="{{asset(Auth::user()->image)}}" alt=""></div>
								<div><a href="#">{{Auth::user()->username}}</a></div>
								<div><a href="{{route('frontend.logout')}}">Đăng xuất</a></div></div>
								@else
								<div class="user_icon"><img src="{{asset('/template/frontend/')}}/images/user.svg" alt=""></div>
								<div><a href="{{route('frontend.register')}}">Đăng ký</a></div>
								<div><a href="{{route('frontend.login')}}">Đăng nhập</a></div>
								@endif
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="{{route('frontend.home')}}">MobileTT</a></div>
						</div>
					</div>
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									...
									<div class="cart_content">
										<div class="cart_text"><a href="{{route('frontend.shopping_cart')}}">Giỏ hàng</a></div>
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="main_nav_menu ml-auto">
								<ul class="standard_dropdown main_nav_dropdown">
									<li><a href="{{route('frontend.home')}}">TRANG CHỦ<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="{{route('frontend.shopping')}}">SHOPPING<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="{{route('frontend.shopping_cart')}}">GIỎ HÀNG<i class="fas fa-chevron-down"></i></a></li>
									<li><a href="{{route('frontend.user_profile')}}">THÔNG TIN NGƯỜI DÙNG<i class="fas fa-chevron-down"></i></a></li>
